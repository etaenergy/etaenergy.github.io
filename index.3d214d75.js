...
//     { visibility: "hidden", height: "0", opacity: 0, backgroundColor: "black", ease: "Power1.easeInOut", delay: 1 }
// );
tml.to(".section_home-header1, .fab", {
    opacity: 1,
    y: 0,
    ease: "Power1.easeInOut"
...
// GSAP Timeline with improved structure
// const inttl = gsap.timeline({
//     defaults: {
//         ease: "Power.easeInOut", // Set a default easing function for all animations
//         duration: 1, // Set a default animation duration
//         stagger: 0.1 // Apply stagger for multiple elements
//     }
// });
// Add animations to the timeline
// inttl.to(".home-intro_heading", {
//         opacity: 1,
//         margin: "0"
//     }, "-=0.2")
//     .to(".intro_image", {
...
//         opacity: 1,
//         margin: "0",
//         ease: "Power2.easeInOut" // Custom easing for this step
//     }, "-=0.6")
...
// ScrollTrigger.create({
//     trigger: ".home-header_btn-container", // The element that triggers the animation
//     start: "top 60%", // Trigger starts when the element hits 60% of the viewport
//     end: "+=50", // Defines the end point of the trigger
//     animation: inttl, // Attach the GSAP timeline to the ScrollTrigger
//     // scrub: 1 // Uncomment to add smooth scrubbing
// });
let mctl = gsap.timeline({
    defaults: {
        duration: 1
    }
});
mctl.to(".marquee-scroll", {
    margin: "0",
    ease: "Power.easeInOut"
}, "-=0.2");
ScrollTrigger.create({
...
let inttlef = gsap.timeline({
    defaults: {
        duration: 1
    }
});
inttlef.to(".course-about_content-container", {
    opacity: 1,
    scale: 0.7,
    ease: "Power.easeInOut",
    margin: "0"
...
let inttleffiv = gsap.timeline({
    defaults: {
        duration: 1
    }
});
inttleffiv.to(".fivedis", {
    scale: 0.9,
    ease: "Power.easeInOut",
    margin: "0"
}, "-=0.2");
ScrollTrigger.create({
    ...
    animation: inttleffiv,
    scrub: true
});
let swptl = gsap.timeline({
    defaults: {
        duration: 1
    }
});
swptl.to(".card-swiper", {
    opacity: 1,
    ease: "Power.easeInOut"
}, "-=0.2");
ScrollTrigger.create({
...
let stcdtl = gsap.timeline({
    defaults: {
        duration: 1
    }
});
stcdtl.to(".testimonial_heading", {
    margin: "0",
    opacity: 1,
    ease: "Power.easeInOut",
    stagger: 0.1
...
//     const footer = document.querySelector('app-footer'); // Select your footer element
//     const pageHeight = document.documentElement.scrollHeight; // Full page height
//     const viewportHeight = window.innerHeight; // Visible area height
//     const scrollPosition = window.scrollY; // Current scroll position
//     const maxScroll = pageHeight - viewportHeight; // Maximum scrollable height
//     // If scrolled beyond the limit (too far down)
//     if (scrollPosition > maxScroll) {
//         window.scrollTo(0, maxScroll); // Reset to the maximum allowed scroll
//     }
//     // Optional: Prevent scrolling up too far if needed
//     if (scrollPosition < 0) {
//         window.scrollTo(0, 0); // Reset to the top
//     }
// });
...
window.onload = function() {
 ...
 //     }
 // });
 // Sample product list (Replace with your actual products)

},{"fuse.js":"l7yrx","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l7yrx":[function(require,module,exports,__globalThis) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dIizP","bB7Pu"], "bB7Pu", "parcelRequire94c2")
