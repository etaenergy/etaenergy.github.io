...
})({"fdM89":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "b0a31ab2da9e2a24";
"use strict";
...
},{}],"c41dc":[function(require,module,exports,__globalThis) {
const products = [
    {
...
document.addEventListener("click", (e)=>{
    if (!searchOverlay.contains(e.target) && !openSearch.contains(e.target)) closeSearchOverlay();
});
...
searchInput.addEventListener("input", function() {
    ...
    if (filteredProducts.length === 0) searchResults.innerHTML = "<p class='text-gray-400 text-center'>No results found</p>";
    else filteredProducts.forEach((product)=>{
        const item = document.createElement("a");
        item.href = product.url;
        item.textContent = product.name;
        item.classList = "block p-3 bg-gray-800 rounded mt-2 cursor-pointer hover:bg-gray-700 text-gray-400 transition text-center";
...
},{}]},["fdM89","c41dc"], "c41dc", "parcelRequire94c2")

//# sourceMappingURL=index.da9e2a24.js.map
