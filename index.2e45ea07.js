...
window.validateForm1 = function() {
    if (!validateName1() || !validatePhone1() || !validateEmail1()) {
        alert('Form not submitted');
        return false;
    } else {
        window.submitted = true;
        setTimeout(showThankYouMessage1, 500); // Show the thank-you message after 1 second
        return true;
    }
};
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (!sessionStorage.getItem('popupShown')) setTimeout(function() {
        popupContainer1.style.display = 'block';
        popupContainer1.classList.add('show');
    }, 5000);
    else popupContainer1.style.display = 'none';
    // Close popup event
 ...
 //     document.getElementById("your-nav-button").addEventListener("click", function () {
 //         document.getElementById("popup-container").style.display = "block";
 //     });
 //     document.getElementById("your-nav-button1").addEventListener("click", function () {
